                    ...
                    <div className="flex flex-wrap -m-4">
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
                                <img alt="testimonial" className="w-20 h-20 mb-8 object-cover object-center rounded-full inline-block border-2 border-gray-200 bg-gray-100" src="https://media.licdn.com/dms/image/D5603AQFpvDH6xmvM3w/profile-displayphoto-shrink_400_400/0/1690562308063?e=1702512000&v=beta&t=rZ-sCVP3m9qflD3bmxUeSouGP6Var0QJWgVKizrXmOQ" />
                                ...
                                <h2 style={{color: mode === 'dark' ? '#ff4162' : ''}} className="text-gray-900 font-medium title-font tracking-wider text-sm uppercase">Omprkash kumar</h2>
                                <p style={{color: mode === 'dark' ? 'white' : ''}} className="text-gray-500">React developer</p>
                            </div>
                        </div>
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
